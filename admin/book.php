    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li>Books</li>
          <li class="active">Book Catalog</li>
        </ol>
      </section>
      <!-- Main content -->
          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header with-border">
                <a href="#addnew" data-toggle="modal" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i> Add New Book</a>
                    ...
                    while ($row = $query->fetch_assoc()) {
                      ...
                      echo "
                        <tr>
                          ...
                          <td>" . $row['isbn'] . "</td>
                          <td>" . $row['title'] . "</td>
                          <td><b>" . $row['room'] . " . " . $row['shelf'] . " . " . $row['row'] ."</b></td>
                          <td>" . $row['author'] . "</td>
                          <td>" . $status . "</td>
                          <td id='dontprint'>
                            <button class='btn btn-info btn-sm edit btn-flat' data-id='" . $row['bookid'] . "'><i class='fa fa-edit'></i> Edit</button>
