    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" method="POST" action="book_add.php">
          ...
          <div class="form-group">
            <label for="publisher" class="col-sm-3 control-label">Entry Clerk</label>
            ...
            <div class="col-sm-9">
              ...
              <select class="form-control" name="publisher" id="publisher" required>
                ...
                while ($crow = $query->fetch_assoc()) {
                  echo "
                              <option value='" . $crow['firstame'] . "'>" . $crow['firstname'] . "</option>
                            ";
                }
                ?>
              </select>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">
              <input type="text" class="form-control" id="shelf" name="shelf" placeholder="Shelf No.">
            </div>
            <div class="col-sm-3">
              <input type="text" class="form-control" id="row" name="row" placeholder="Row No.">
            </div>
          </div>
          <div class="form-group">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" method="POST" action="book_edit.php">
          ...
          <div class="form-group">
            <label for="edit_publisher" class="col-sm-3 control-label">Entry Clerk</label>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">
              <input type="text" class="form-control" id="edit_room" name="room" placeholder="Room No.">
            </div>
            <div class="col-sm-3">
              <input type="text" class="form-control" id="edit_shelf" name="shelf" placeholder="Shelf No.">
            </div>
            <div class="col-sm-3">
              <input type="text" class="form-control" id="edit_row" name="row" placeholder="Row No.">
            </div>
          </div>
